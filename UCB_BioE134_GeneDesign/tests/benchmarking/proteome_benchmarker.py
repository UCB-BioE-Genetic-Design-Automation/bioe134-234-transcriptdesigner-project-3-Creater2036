...
def benchmark_proteome(fasta_file):
    ...
    prot_2 = {k: proteome[k] for k in list(proteome)[:70]} #Just going to run some of them instead of all
    successful_results = []
    error_results = []

    for gene, protein in prot_2.items():
        try:
...
if __name__ == "__main__":
    ...
    #fasta_file = "/content/drive/MyDrive/VSCode/Genetic_Frame/UCB_BioE134_GeneDesign/tests/benchmarking/uniprotkb_proteome_UP000054015_2024_09_24.fasta"
    #print(os.getcwd())
    fasta_file = "uniprotkb_proteome_UP000054015_2024_09_24.fasta"
